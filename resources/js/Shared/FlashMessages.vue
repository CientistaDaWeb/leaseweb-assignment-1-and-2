<template>
  <div>
    <div v-if="$page.props.flash && show" class="flex items-center justify-between mb-8 max-w-3xl bg-green-500 rounded">
    ...
    <div v-if="($page.props.flash || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between mb-8 max-w-3xl bg-red-500 rounded">
      <div class="flex items-center">
        ...
        <div v-if="$page.props.flash" class="py-4 text-white text-sm font-medium">{{ $page.props.flash.error }}</div>
